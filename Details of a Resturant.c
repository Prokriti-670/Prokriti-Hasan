...
gets(num1);
        ...
        {int n=4,i,i1,i2,i3;
            for(i=1; i<=n; i++)
            {
                ...
                if(i==1)
                {
                    ...
                    for(i1=1; i1<=1; i1++)
                    {
                        puts("Chicken Pizza(12 inches) 550/=");
                        puts("Chicken Burger 350/=");
                        puts("Chicken Fry(Per Piece) 100/=");
                        puts("Fried Rice 200/=");
                        puts("Chicken Pasta 200/=");
                        puts("Momos 40/=");
                        puts("Chicken Grill 100/=");
                        puts("Beef Steak(250 gm) 900/=");
                        puts("French Fry 100/=");
                        puts("Beef Sandwich 100/=");
                    }
                }
                else if(i==2)
                {
        ...
        if(project==4)
        {
            ...
            FILE *fp;
            fp=fopen("1st.txt","w");
            int sum=0,sum1=0,sum2=0,sum3=0,sum4=0,sum5=0,sum6=0,sum7=0,sum8=0,sum9=0,sum10=0,Sum=0;
            ...
            for(j=1; j<=a1; j++)
            {
                ...
                fprintf(fp,"%d.\n",j);printf("Enter Customer's Name:\n");
                fflush(stdin);
                gets(name);
                fprintf(fp,"             Name:%s\n",name);
...
fprintf(fp,"            Order no. & Item: %d.Fresh Water      ",order);
                    ...
                    if(order==1)
                    {
                        cost1=cost1+550;/*12 inch*/
                        sum1=sum1+(quantity1*cost1);
                    }
                    if(order==2)
                    {
                        cost2=cost2+350;
                        sum2=sum2+(quantity1*cost2);
                    }
                    if(order==3)
                    {
                        cost3=cost3+100;
                        sum3=sum3+(quantity1*cost3);
                    }
                    if(order==4)
                    {
                        cost4=cost4+200;
                        sum4=sum4+(quantity1*cost4);
                    }
                    if(order==5)
                    {
                        cost5=cost5+300;
                        sum5=sum5+(quantity1*cost5);
                    }
                    if(order==6)
                    {
                        cost6=cost6+40;
                    ...
                    {
                        cost7=cost7+100;
                        sum7=sum7+(quantity1*cost7);
                    }
                    if(order==8)
                    {
                        cost8=cost8+900;/*250 gm*/
                        sum8=sum8+(quantity1*cost8);
                    }
                    if(order==9)
                    {
                        cost9=cost9+100;
                        sum9=sum9+(quantity1*cost9);
                    }
                    if(order==10)
                    {
                        cost10=cost10+100;
                        sum10=sum10+(quantity1*cost10);
                    }
                    if(order==11)
                    {
                        cost11=cost11+120;
                        sum11=sum11+(quantity1*cost11);
                    }
                    if(order==12)
                    {
                        cost12=cost12+60;
                        sum12=sum12+(quantity1*cost12);
                    }
                    if(order==13)
                    {
                        cost13=cost13+80;
                        sum13=sum13+(quantity1*cost13);
                    }
                    if(order==14)
                    {
                        cost14=cost14+50;
                        sum14=sum14+(quantity1*cost14);
                    }

                    if(order==15)
                    {
                        cost15=cost15+20;
                        sum15=sum15+(quantity1*cost15);
                    }
                    if(order==16)
                    {
                        cost16=cost16+20;
                        sum16=sum16+(quantity1*cost16);
                    }
                    if(order==17)
                    {
                        cost17=cost17+20;
                ...
                puts(name);
                printf("Your Bill is:%.2f(By adding 15%% vat without drinks)\n",total);
